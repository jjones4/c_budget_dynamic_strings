...
$(TARGET): c_budget_dynamic_strings.o menus.o validation.o read_input.o crud_operations.o
	$(CC) $(CFLAGS) -o c_budget_dynamic_strings c_budget_dynamic_strings.o menus.o validation.o read_input.o crud_operations.o

c_budget_dynamic_strings.o: $(TARGET).c menus.c validation.c read_input.c crud_operations.c
